 ...
 * @author IGG
 */
public class MsgRespRankKillTotal extends MsgHead {
  public int pageId;
  public int maxPageId;
  public int dataLen;
  public RankUser[] data;
  
  public MsgRespRankKillTotal() {
    super();
    
    this.data = new RankUser[MsgTypes.MAX_RANKPAGELEN];
    for(int idx = 0; idx < MsgTypes.MAX_RANKPAGELEN; idx++) {
      this.data[idx] = new RankUser();
    }
    
    super.usSize = this.getLength();
    super.usType = MsgTypes.MSG_RESP_RANKKILLTOTAL;
  }
  ...
  public short getLength(short param1) {
    return 16 + RankUser.LENGTH * MsgTypes.MAX_RANKPAGELEN;
  }
