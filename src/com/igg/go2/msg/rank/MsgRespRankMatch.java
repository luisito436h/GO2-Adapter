 ...
 * @author IGG
 */
public class MsgRespRankMatch extends MsgHead {
  public int pageId;
  public int maxPageId;
  public int dataLen;
  public RankMatch[] data;
  
  public MsgRespRankMatch() {
    super();
    
    this.data = new RankMatch[MsgTypes.MAX_RANKPAGELEN];
    for(int idx = 0; idx < MsgTypes.MAX_RANKPAGELEN; idx++) {
      this.data[idx] = new RankMatch();
    }
    
    super.usSize = this.getLength();
    super.usType = MsgTypes.MSG_RESP_RANKMATCH;
  }
  ...
  public short getLength(short param1) {
    return 16 + RankMatch.LENGTH * MsgTypes.MAX_RANKPAGELEN;
  }
